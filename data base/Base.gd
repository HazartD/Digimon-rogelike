extends Node
enum LOCATIONS{DS,DR,JT,ME,NSP,NSO,VB,WG,DA,UK,CRACK_TEAM_BASE,FILE_CITY,SHORE}
enum ITEMS{X_ANTIBODY,USB_DEFEND,USB_ATTACK,USB_INTELIGENT,USB_SPEED,USB_LIFE,USB_ENERGY,USB_WILL,USB_FIGHTER,Vitality_Disk,Monk_Disk,Assassin_Disk,Warrior_Disk}
enum ITEMS_TYPE{BASIC,ADD_SKILL,QUICK_EVO_OR_SKILL,QUICK_EVO,IN_WAITING_EVO,ADD_DATA}
enum SKILLS{NONE,X_ANTIBODY}
enum EVO_TYPE{NONE,X_ANTIBODY}
var base:Dictionary={}
